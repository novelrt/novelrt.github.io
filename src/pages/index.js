                ...
                <div id="main-branding" className="flex flex-col items-center py-12 md:px-12 lg:px-36 xl:px-46 2xl:px-64 bg-gradient-to-b from-green-400 via-blue-500 to-indigo-600">
                    ...
                    <div id="features" className="flex flex-col gap-12 xl:grid xl:grid-cols-3 xl:gap-x-20 mt-20 mx-20 md:mx-28 xl:mx-36">
                        <div className="flex flex-col items-center">
                            ...
                            <h3 className="mt-2 font-semibold text-center text-3xl xl:text-lg">Cross-Platform</h3>
                            <p className="mt-2 text-center text-lg xl:text-sm">
                                We make an active effort to bring NovelRT to as many platforms as we can, so you can focus on building your games. Right now we support Windows and Linux, with Web, MacOS, iOS and Android being actively developed!
                            </p>
                        </div>
                        <div className="flex flex-col items-center">
                            <div className="bg-gray-100 rounded-full py-2 px-2 w-16 h-16 xl:w-14 xl:h-14 shadow-lg">
                            ...
                            <h3 className="mt-2 font-semibold text-center text-3xl xl:text-lg">Use what you love</h3>
                            <p className="mt-2 text-center text-lg xl:text-sm">
                                C#, Ink, Lua, MoonScript or C++? The core of NovelRT is written in C++ to give you the performance you need, but we provide in-depth bindings for powerful ecosystems like .NET. You can't find you favorite language? Just contribute language bindings yourself!
                            </p>
                        </div>
                        <div className="flex flex-col items-center">
                            <div className="bg-gray-100 rounded-full py-2 px-2 w-16 h-16 xl:w-14 xl:h-14 shadow-lg">
                            ...
                            <h3 className="mt-2 font-semibold text-center text-3xl xl:text-lg">Built for modularity</h3>
                            <p className="mt-2 text-center text-lg xl:text-sm">
                                NovelRT features a well-crafted multi-threaded Entity Component System and promotes Data Oriented Design so that your codebase scales with your project. Batched rendering and high code reusability are a core focus for us.
                            </p>
                        </div>
                    </div>
                </div>
                <div id="secondary-branding" className="flex flex-col gap-12 xl:gap-16 items-center py-16 md:px-12 lg:px-36 xl:px-46 2xl:px-64 mx-24 md:mx-36 xl:mx-64 text-gray-800">
                    <div className="flex flex-col xl:flex-row items-center xl:flex xl:items-center">
                        <div className="xl:mx-12">
                            <div className="bg-gradient-to-br text-gray-100 from-green-400 via-blue-500 to-pink-600 rounded-full py-3 px-3 xl:py-6 xl:px-6 w-16 h-16 xl:w-36 xl:h-36 shadow">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.25} d="M4 8V4m0 0h4M4 4l5 5m11-1V4m0 0h-4m4 0l-5 5M4 16v4m0 0h4m-4 0l5-5m11 5l-5-5m5 5v-4m0 4h-4" />
                                </svg>
                            </div>
                        </div>
                        <div>
                            <h3 className="mt-2 xl:mt-0 font-semibold xl:font-normal text-center xl:text-left text-3xl xl:text-4xl">2D games made seamless.</h3>
                    ...
                    <div className="flex flex-col xl:flex-row items-center xl:flex xl:items-center">
                        ...
                        <div>
                            <h3 className="mt-2 xl:mt-0 font-semibold xl:font-normal text-center xl:text-left text-3xl xl:text-4xl">Write narratives. Not boilerplate.</h3>
                            <p className="mt-2 text-center xl:text-left">
