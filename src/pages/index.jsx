            ...
            <Layout>
                ...
                >
                    ...
                    <h2 className="text-lg mx-16 xl:w-1/2 text-center">
                        NovelRT is a low-ceremony multi-platform open source
                        game engine with a strong focus on 2D Game Development
                        and first-class support for Novel Game Development.
                    </h2>
                    <div
                        id="features"
                    ...
                    >
                        <div className="flex flex-col items-center">
                            ...
                            <p className="mt-2 text-center text-lg xl:text-sm">
                                We make an active effort to bring NovelRT to as
                                many platforms as we can, so you can focus on
                                building your games. Right now we support
                                Windows and Linux, with Web, MacOS, iOS and
                                Android being actively developed!
                            </p>
                        </div>
                        <div className="flex flex-col items-center">
                            <div className="bg-gray-100 rounded-full py-2 px-2 w-16 h-16 xl:w-14 xl:h-14 shadow-lg">
                            ...
                            <p className="mt-2 text-center text-lg xl:text-sm">
                                C#, Ink, Lua, MoonScript or C++? The core of
                                NovelRT is written in C++ to give you the
                                performance you need, but we provide in-depth
                                bindings for powerful ecosystems like .NET. You
                                can&apos;t find you favorite language? Just
                                contribute language bindings yourself!
                            </p>
                        </div>
                        <div className="flex flex-col items-center">
                            <div className="bg-gray-100 rounded-full py-2 px-2 w-16 h-16 xl:w-14 xl:h-14 shadow-lg">
                            ...
                            <p className="mt-2 text-center text-lg xl:text-sm">
                                ...
                                Entity Component System and promotes Data
                                Oriented Design so that your codebase scales
                                with your project. Batched rendering and high
                                code reusability are a core focus for us.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="flex flex-col xl:flex-row items-center xl:flex xl:items-center">
                        ...
                        <div>
                            ...
                            <p className="mt-2 text-center xl:text-left">
                                ...
                                games. The tooling is designed to support any
                                kind of 2D game you can imagine! From puzzlers,
                                metroidvanias, platformers, RTS games or even
                                just your average Tetris clone!
                            </p>
                        </div>
                    </div>
                    <div className="flex flex-col xl:flex-row items-center xl:flex xl:items-center">
                        ...
                        <div>
                            ...
                            <p className="mt-2 text-center xl:text-left">
                                Tired of writing tools and burning out before
                                you can actually write your visual novel script?
                                Do you want a tool that has it integrated as
                                part of the platform? NovelRT is built to
                                support your inner playwright from the get go!
                            </p>
                        </div>
