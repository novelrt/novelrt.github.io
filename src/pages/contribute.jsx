    ...
    return (
        <main className="bg-gray-100 min-h-screen">
            ...
            <Layout>
                ...
                >
                    <h1 className="my-4 text-5xl tracking-wide text-center">How to contribute.</h1>
                    <h2 className="text-lg mx-16 xl:w-1/2 text-center">
                        NovelRT is under active development as we continue to enhance the 2D/Visual
                        Novel development experience. With that said, here are a few ways you can
                        contribute:
                    </h2>
                    <div
                        id="features"
                ...
                >
                    ...
                    >
                        ...
                        <div>
                            ...
                            <p className="mt-2 text-center xl:text-left">
                                Want to help out the NovelRT project? Thanks! We appreciate all the
                                help we can get. To get started,{" "}
                                <a
                                    className="underline hover:text-gray-500 duration-300"
                                    target="_blank"
                                    rel="noreferrer"
                    ...
                    >
                        ...
                        <div>
                            ...
                            <p className="mt-2 text-center xl:text-left">
                                Feeling stuck? Don't know where to start? Have some questions?{" "}
                                <a
                                    className="underline hover:text-gray-500 duration-300"
                                    target="_blank"
                                    rel="noreferrer"
